...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./pics/schematic.png}
...
\begin{figure*}[!htb]
    {\includegraphics[ width=0.5\textwidth]{./pics/bodmas.png}}
    \hspace{\fill}
    {\includegraphics[ width=0.5\textwidth]{./pics/bodmas_calc.png}}
\end{figure*}
\FloatBarrier

\subsection{Trigonometric Functions and Inverse Trigonometric Functions Implementation}
\begin{figure*}[!htb]
    {\includegraphics[width=0.5\textwidth]{./pics/trig.png}}
    \hspace{\fill}
    {\includegraphics[width=0.5\textwidth]{./pics/trig_calc.png}}
\end{figure*}

\subsection{Power Implementation}
\begin{figure*}[!htb]
    {\includegraphics[width=0.5\textwidth]{./pics/pow.png}}
    \hspace{\fill}
    {\includegraphics[width=0.5\textwidth]{./pics/pow_calc.png}}
\end{figure*}

\subsection{Natural Logarithm Implementation}
\begin{figure*}[!htb]
    {\includegraphics[width=0.5\textwidth]{./pics/ln.png}}
    \hspace{\fill}
    {\includegraphics[width=0.5\textwidth]{./pics/ln_calc.png}}
\end{figure*}
...
\begin{figure*}[!htb]
    ...
    \hspace{\fill}
    {\includegraphics[width=0.5\textwidth]{./pics/log_calc.png}}
\end{figure*}
