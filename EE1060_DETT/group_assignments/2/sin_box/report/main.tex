...
\title{Convolution of a Sinusoidal Signal with a Shifted Rectangular Kernel}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../codes/figs/original_vs_convolved.png}
    \end{center}
    \caption{Original Signal vs Convolved Signal plot}
\end{figure}
\FloatBarrier

\section{Effect of Kernel Shift $\tau_0$}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../codes/figs/varying_tau_effect.png}
    \end{center}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=1\textwidth]{../codes/figs/varying_T_pi_effect.png}
    \end{center}
\end{figure}
\FloatBarrier
...
\section{Amplitude ratio Analysis}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../codes/figs/scaling_factor_analysis.png}
    \end{center}
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../codes/figs/scaling_factor_analysis_T.png}
    \end{center}
...
\section{More analysis on Effect of Kernel Width (T)}
The convolved ouput's amplitude ratio is sinusoidal with respect to T when all the other parameters are constant.

\begin{figure}[!ht]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{../codes/figs/varying_T_effect.png}
    \end{center}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/noisy_sin_plot.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/noisy_step_plot.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/noisy_square_plot.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/noisy_ramp_plot.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/noisy_decay_plot.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/noisy_gaussian_plot.png}
\caption{Noisy Gaussian and Smoothed Gaussian}
\end{figure}
\FloatBarrier

\section{Smoothening out Gibbs phenomena in Fourier Reconstruction using Box Kernel}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/fourier_box_N50.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\textwidth]{../codes/figs/fourier_box_N100.png}
